...
If you have any questions just send me an email via [micky-github@salamander.co.uk](mailto:micky-github@salamander.co.uk) and if you want to have a far more detailed explanation of how to publish a webpage using Git (which is basically what this tutorial was all about) have a look at  **[Max Harlow's excellent tutorial](https://github.com/maxharlow/tutorials/tree/master/build-a-website-with-html-and-git)** on the subject.
